		...
		<view class="other_warp">
			<view class="other-area">
				<text class="other-item">
					参考均价:<text class="red MR_R">{{doFormatAveragePrice(baseInfo.referenceAveragePriceType,baseInfo.referenceAveragePrice)}}</text>
				</text>
				<text class="other-item">
					参考总价:<text class="red MR_R">{{$formatter.formatTotalPrice1(baseInfo.referenceTotalPriceMin,baseInfo.referenceTotalPriceMax)}}</text>
				</text>
			</view>
			<view class="other-houseType">
				<text class="other-item">
					在售户型:<text class="black MR_R">{{baseInfo.houseType?baseInfo.houseType+'室':'待定'}}</text>
				</text>
				<text class="other-item">
					建筑面积:<text class="black MR_R">{{$formatter.formatArea1(baseInfo.referenceBuildAreaMin,baseInfo.referenceBuildAreaMax)}}</text>
				</text>
			</view>
			<view class="other-address">
				楼盘地址:<text class="MR_R">青浦-徐泾 路西路996号</text>
			</view>
		</view>
