      ...
      <view class="other_warp">
        <view class="other-area">
          ...
          <view class="other-item bord">
            <view class="red">{{$formatter.formatTotalPrice1(baseInfo.referenceTotalPriceMin,baseInfo.referenceTotalPriceMax)}}<text class="unit"
                v-if="baseInfo.referenceTotalPriceMin||baseInfo.referenceTotalPriceMax">万</text></view>
            <view class="label">参考总价</view>
          </view>
          <view class="other-item">
            <view class="red">{{$formatter.formatArea1(baseInfo.referenceBuildAreaMin,baseInfo.referenceBuildAreaMax)}}<text class="unit"
                v-if="baseInfo.referenceBuildAreaMin||baseInfo.referenceBuildAreaMax">㎡</text></view>
    ...
    doFormatAveragePrice(type, averagePriceMin, averagePriceMax) {
      ...
      if (!averagePriceMin) {
        ...
        if (type == 1) {
          ...
          str = `${this.unitChange(averagePriceMin)}-${this.unitChange(
            averagePriceMax
          )}`
        } else {
          str = `${this.unitChange(averagePriceMin)}`
