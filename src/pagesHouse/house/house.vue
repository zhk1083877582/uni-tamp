...
<template>
  <view class="pageHouse-buildingInfo">
    ...
    <building-info ref="reBuildingInfo" :baseInfo="baseInfo" :buildingId="buildingId" :userId="userId">
    </building-info>
    <!-- 楼盘简介 -->
    <house-describe :class="scrollTabs['introduce']['cl']" v-if="scrollTabs['introduce'].isShow" :descriptionInfo="descriptionInfo">
    </house-describe>
    <!-- 楼盘动态 -->
    <house-dynamic :class="scrollTabs['dynamic']['cl']" v-if="dongtaiInfo.isShow" :dongtaiInfo="dongtaiInfo" :userId="userId" @changeCollectionStatus="doChangeCollectionStatus">
    </house-dynamic>
    <!-- 户型 -->
    <house-style :class="scrollTabs['style']['cl']" v-if="isShowHouseStyle" :totalHouseStyleList="totalHouseStyleList" :houseTabs="houseTabs" :buildingId="buildingId" :userId="userId"
      @makePhone="handlerMakePhone">
    </house-style>

    <!-- 楼栋分布 -->
    <house-spread :class="scrollTabs['spread']['cl']" v-if="spreadAnnexPath" :buildingId="buildingId" :userId="userId" :spreadAnnexPath="spreadAnnexPath"
      :buildingUnitBaseInfoList="buildingUnitBaseInfoList">
    </house-spread>
    <!-- 周边配套 -->
    <house-periphery :class="scrollTabs['periphery']['cl']" v-if="baseInfo.lat && baseInfo.lng" :baseInfo="baseInfo" :userId="userId" @makePhone="handlerMakePhone">
    </house-periphery>
    <!-- 楼盘亮点 -->
    <house-highlights :class="scrollTabs['highlights']['cl']" v-if="scrollTabs['highlights'].isShow" :highlightsInfo="highlightsInfo">
    </house-highlights>
    <!-- 免责声明 -->
