...
<template>
  <view class="login_warp">
    <image src="https://images.tospurfang.com/5259F332FEF24BB1B2699C7A3CC205E8-6-2.jpg"
      class="login_log"></image>
    <view class="btn_warp">
      <!-- #ifdef MP-WEIXIN -->
      <button class="WX_btn" @click="onGetUserInfo">
        <i class="iconfont icondenglu-weixin"></i>
        微信授权登录
      </button>
      <!-- #endif -->
      <!-- <button @click="doTelLogin">
