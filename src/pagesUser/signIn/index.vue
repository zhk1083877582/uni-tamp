        ...
        <view class="img_warp" v-if="!showAuthorize">
          <view class="configImg_warp">
            <view class="configImg"><text class="img_text">区位介绍</text>
              <image src="https://images.tospurfang.com/4E1BEB8C86B24C52BCE829E4AD8220E8-6-2.jpg" mode=""></image>
            </view>
            <view class="configImg"><text class="img_text">沙盘介绍</text>
              <image src="https://images.tospurfang.com/BEC371A31E4B497BB353D8BEE11F423D-6-2.jpg" mode=""></image>
            </view>
          </view>
          <view class="configImg_warp MR_T">
            <view class="configImg"><text class="img_text">样板间带看</text>
              <image src="https://images.tospurfang.com/F029999A5A034BD39B2B8F703FDE55BA-6-2.jpg" mode=""></image>
            </view>
            <view class="configImg"><text class="img_text">沟通洽谈</text>
              <image src="https://images.tospurfang.com/4B2A4B48FC934EBEB6536DBE064C261B-6-2.jpg" mode=""></image>
            </view>
          </view>
        </view>
...
.sing_in {
  ...
  .bottom_main {
    .bottom_bg {
      width: 100%;
      height: 50%;
      background: url(https://images.tospurfang.com/26CDF733F70A4F0A9898559F17EF7995-6-2.jpg)
        no-repeat;
